        ...
        return '<div class="pred-item ' + p.status + '" role="listitem">' +
          '<div class="pred-item-header">' +
            ...
            '<div style="display:flex;align-items:center;gap:8px">' +
              (canEdit ? '<button onclick="openMatchDetail(' + "'" + (p.matchId || 'upcoming1') + "'" + ')" style="font-size:0.65rem;font-weight:700;padding:2px 8px;border-radius:100px;background:rgba(60,184,46,0.1);border:1px solid rgba(60,184,46,0.3);color:var(--green);cursor:pointer">Edit</button>' : '') +
