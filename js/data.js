  ...
  continents: {
    europe: {
      ...
      leagues: [
        ...
        { id: 'bundesliga', name: 'Bundesliga', country: '🇩🇪', emoji: '🇩🇪', matches: 38, color: '#D3010C' },
        { id: 'seriea', name: 'Serie A', country: '🇮🇹', emoji: '🇮🇹', matches: 44, color: '#024494' },
        { id: 'ligue1', name: 'Ligue 1', country: '🇫🇷', emoji: '🇫🇷', matches: 36, color: '#182A4E' },
        { id: 'ucl', name: 'Champions League', country: '🇪🇺', emoji: '⭐', matches: 22, color: '#1B0E60' },
        { id: 'uel', name: 'Europa League', country: '🇪🇺', emoji: '🟠', matches: 18, color: '#FF6900' },
        { id: 'eredivisie', name: 'Eredivisie', country: '🇳🇱', emoji: '🇳🇱', matches: 30, color: '#EF7D00' },
        { id: 'primeirliga', name: 'Primeira Liga', country: '🇵🇹', emoji: '🇵🇹', matches: 34, color: '#009B3A' },
        { id: 'superlig', name: 'Süper Lig', country: '🇹🇷', emoji: '🇹🇷', matches: 38, color: '#E30A17' },
      ]
    },
    africa: {
      label: 'Africa',
      leagues: [
        { id: 'caf-cl', name: 'CAF Champions League', country: '🌍', emoji: '🏆', matches: 24, color: '#009A44' },
        { id: 'afcon', name: 'AFCON 2026', country: '🌍', emoji: '🇲🇦', matches: 32, color: '#C1272D' },
        { id: 'npfl', name: 'NPFL (Nigeria)', country: '🇳🇬', emoji: '🇳🇬', matches: 28, color: '#008751' },
        { id: 'psl', name: 'PSL (South Africa)', country: '🇿🇦', emoji: '🇿🇦', matches: 32, color: '#007A4D' },
        { id: 'egipt', name: 'Egyptian Premier League', country: '🇪🇬', emoji: '🇪🇬', matches: 30, color: '#C09300' },
        { id: 'caf-cc', name: 'CAF Confederation Cup', country: '🌍', emoji: '🥈', matches: 20, color: '#F77F00' },
      ]
    },
    americas: {
      label: 'Americas',
      leagues: [
        { id: 'mls', name: 'MLS', country: '🇺🇸', emoji: '🇺🇸', matches: 36, color: '#1A3657' },
        { id: 'brasileirao', name: 'Brasileirão', country: '🇧🇷', emoji: '🇧🇷', matches: 38, color: '#009C3B' },
        { id: 'liga-mx', name: 'Liga MX', country: '🇲🇽', emoji: '🇲🇽', matches: 34, color: '#006847' },
        { id: 'libertadores', name: 'Copa Libertadores', country: '🌎', emoji: '🏆', matches: 26, color: '#F5C518' },
        { id: 'copa-america', name: 'Copa América 2026', country: '🌎', emoji: '🌎', matches: 28, color: '#003087' },
        { id: 'arg-primera', name: 'Primera División (ARG)', country: '🇦🇷', emoji: '🇦🇷', matches: 30, color: '#74ACDF' },
      ]
    },
    asia: {
      label: 'Asia',
      leagues: [
        { id: 'jleague', name: 'J-League', country: '🇯🇵', emoji: '🇯🇵', matches: 34, color: '#00559A' },
        { id: 'kleague', name: 'K League 1', country: '🇰🇷', emoji: '🇰🇷', matches: 32, color: '#C60C30' },
        { id: 'saudi', name: 'Saudi Pro League', country: '🇸🇦', emoji: '🇸🇦', matches: 30, color: '#007A3D' },
        { id: 'chinese-sl', name: 'Chinese Super League', country: '🇨🇳', emoji: '🇨🇳', matches: 30, color: '#DE2910' },
        { id: 'afc-cl', name: 'AFC Champions League', country: '🌏', emoji: '⭐', matches: 22, color: '#F77F00' },
        { id: 'isl', name: 'Indian Super League', country: '🇮🇳', emoji: '🇮🇳', matches: 34, color: '#FF7722' },
      ]
    },
    oceania: {
      label: 'Oceania',
      leagues: [
        { id: 'a-league', name: 'A-League (Australia)', country: '🇦🇺', emoji: '🇦🇺', matches: 28, color: '#003087' },
        { id: 'nzfl', name: 'NZFL (New Zealand)', country: '🇳🇿', emoji: '🇳🇿', matches: 16, color: '#000000' },
        { id: 'ofc-cl', name: 'OFC Champions League', country: '🌏', emoji: '🏆', matches: 12, color: '#2E5F96' },
      ]
    },
    world: {
      ...
      leagues: [
        ...
        { id: 'ucl', name: 'UEFA Champions League', country: '🌍', emoji: '⭐', matches: 22, color: '#1B0E60' },
        { id: 'nations', name: 'UEFA Nations League', country: '🇪🇺', emoji: '🇪🇺', matches: 48, color: '#003087' },
        { id: 'friendly', name: 'Internationals/Friendlies', country: '🌍', emoji: '⚽', matches: '∞', color: '#444' },
      ]
    }
  },
